...
export var getBudget = function () {
    return __awaiter(this, void 0, void 0, function () {
        var response, budget, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, fetch(GET_BUDGET_URL_ENDPOINT)];
                case 1:
                    response = _a.sent();
                ...
                case 5:
                    error_1 = _a.sent();
                    console.error('get budget network error: ' + error_1);
                    return [3 /*break*/, 6];
...
export var setNewBudget = function (amount) {
    return __awaiter(this, void 0, void 0, function () {
        var response, budget, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, fetch(createUpdateBudgetUrlEndpoint(amount), {
                            method: "POST"
                        })];
                case 1:
                    response = _a.sent();
                ...
                case 5:
                    error_2 = _a.sent();
                    console.error('set new budget error: ' + error_2);
                    return [3 /*break*/, 6];
                case 6: return [2 /*return*/];
            }
        });
...
//# sourceMappingURL=FetchBudget.js.map